...
cx_Freeze.setup(
    ...
    options={"build_exe": {"packages": ["pygame"],
                           "include_files": [("sound_files/begin_digits.wav", "sound_files/begin_digits.wav"),
                                             ...
                                             ("sound_files/alphabet/found_letter.wav", "sound_files/alphabet/found_letter.wav"),
                                             ("sound_files/alphabet/the_letter.wav", "sound_files/alphabet/the_letter.wav"),
                                             ("sound_files/alphabet/learn_lower_abc.wav", "sound_files/alphabet/learn_lower_abc.wav"),
